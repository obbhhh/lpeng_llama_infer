#ifndef LPENG_LLAMA_INFER_INCLUDE_MODEL_LLAMA_CONFIG_H_
#define LPENG_LLAMA_INFER_INCLUDE_MODEL_LLAMA_CONFIG_H_
#include <ostream>
namespace model {
struct ModelConfig {
  int32_t dim = 0;
...
#endif  // LPENG_LLAMA_INFER_INCLUDE_MODEL_LLAMA_CONFIG_H_
